...
sql_cd  = """
CREATE DATABASE "{dbname}" ENCODING "utf8" LC_COLLATE "en_US.UTF-8";
"""
sql_dd = """
DROP DATABASE IF EXISTS "{dbname}";
"""
sql_cu  = """
CREATE USER "{user}" with encrypted password '{password}'; -- postgresql does not support server param: {server}
"""
sql_du = """
DROP USER IF EXISTS "{user}"; -- postgresql does not support server param: {server}
"""
sql_gu  = """
GRANT ALL PRIVILEGES ON DATABASE "{dbname}" TO "{user}"; -- postgresql does not support server param: {server}
"""
